...
public class BlacklistService {
    ...
    public static String getBlacklistChaincodeIdOrThrow(CloudPlatformService cloudPlatformService) {
    ...
    public static String getBlacklistChaincodeIdOrThrow() {
        return getBlacklistChaincodeIdOrThrow(new CloudPlatformService());
    }
    ...
    public void removeEmailFromBlacklist(String emailAddress) throws Exception {
        blockchainService.invokeOrQuery(FabricInvocationType.INVOKE, blacklistChaincodeId, "remove", "email",
                emailAddress);
    }
}
