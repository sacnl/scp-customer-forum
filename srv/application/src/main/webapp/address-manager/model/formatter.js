...
sap.ui.define([
    ...
    return {
        ...
        blacklistStatus: function (bStatusKnown, iStatus) {
            if(!bStatusKnown) {
                return this.getResourceBundle().getText("noBlacklistInfo");
            }
            ...
            return this.getResourceBundle().getText("blacklistTemplate", [statusText]);
        },
